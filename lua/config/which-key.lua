...
local mappings = {
  ...
  { "<Space>mt", "<cmd>CMakeSelectBuildTarget<CR>", desc = "SelectBuildTarget", nowait = true, remap = false },
  { "<Space>ml", "<cmd>CMakeSelectLaunchTarget<CR>", desc = "SelectLanuchTarget", nowait = true, remap = false },
